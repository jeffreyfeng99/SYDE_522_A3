...
if __name__ == "__main__":
    ...
    source_image_root = os.path.join('data', source_dataset_name).replace("\\","/")
    target_image_root = os.path.join('data', target_dataset_name).replace("\\","/")
    cuda = True
    ...
    dataset_source = GetLoader(
        data_root=os.path.join(source_image_root, 'train_set').replace("\\","/"),
    ...
    dataset_target = GetLoader(
        data_root=os.path.join(target_image_root, 'test_set').replace("\\","/"),
